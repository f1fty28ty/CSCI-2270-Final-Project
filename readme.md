...
- **transactionBalance(address)** - Calculates the balance of all transactions in the block. Adds to the balance if the user receives money and subtracts if they are the sender, provided they have sufficient funds.
